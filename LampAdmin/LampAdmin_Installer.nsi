...
!define NAME 		"LampNet Administrator"
!define FULLNAME	"${NAME} ${VERSION}"
!define EXEFILE		"LampAdmin.exe"
...
Section "" ;No components page, name is not important
    ...
    SetOutPath $TEMP
    File ..\..\base\lib\dotnetfx_2_0_50727.exe
...
Net2Installed:
  ...
  File "..\..\base\CSUtils\bin\Release\CSUtils.dll"
  File "..\..\base\lib\nunit.framework.dll"
